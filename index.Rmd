...
The schedule can be found [here](schedule.html). The event has four thematic blocks, corresponding to the main research areas in our department: Theoretical Statistics, Applied Statistics, Mathematical Finance and Actuarial Science, and Graphical Models. The abstracts can be found [here](abstracts.html). If you have any questions, please do not hesitate to reach out to a member of the organizing committee.
...
=======
    <td>Jingxin (Owen) Wang</td>
>>>>>>> parent of bafaecd (Update index.Rmd)
  </tr>
</table>
